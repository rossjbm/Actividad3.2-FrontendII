...
export function AlertaExito() {
    ...
    return(<>
        <ModoOscuro>
            {(isDarkMode) => (
                <div className={alerta === 1 ? ` border-t-4  rounded-b  px-4 py-3 shadow-md fixed z-30 top-0 w-full ${isDarkMode ? `bg-dark-greenClaro border-white text-white` : `bg-green-100 border-black text-black`}` : "hidden"} role="alert">
                    <div className="flex">
                    ...
                    <div className='w-full flex flex-col gap-3'>
                        <p className="font-bold font-textos text-xl">Ejecutado con Éxito</p>
