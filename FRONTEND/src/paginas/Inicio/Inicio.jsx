...
export function Inicio() {
  ...
  return (
    <ModoOscuro>
      {(isDarkMode) => (
        <>
          <article className={`flex flex-col gap-20 ${isDarkMode ? 'dark:text-white' : ''}`}>
            <div className={`static h-56 bg-bgFondo1 bg-cover bg-fixed w-full ${isDarkMode ? 'dark:bg-gray-900' : 'bg-gray-400'}`}>
            ...
            <div className={`font-textos text-lg flex flex-col p-10 gap-6 text-justify md:px-56 md:flex-row md:gap-14 ${isDarkMode ? 'dark:text-white' : ''}`}>
              <p className="md:bg-gradient-to-t from-blue-200 to-green-100 md:p-5">
            ...
            <div className={`static h-36 bg-bgFondo1 bg-cover bg-fixed w-full ${isDarkMode ? 'dark:bg-gray-900' : 'bg-gray-400'}`}>
              <div className="flex justify-center items-center w-full h-36 bg-gray-400 p-5">
                <h2 className={`text-white text-3xl font-textos text-center ${isDarkMode ? 'dark:text-gray-300' : ''}`}>Horarios</h2>
              </div>
            </div>

            <div className={`font-textos grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-11 p-10 mb-24 ${isDarkMode ? 'dark:text-white' : ''}`}>
              <Horarios />
            </div>
            ...
            <div className={`mb-24 ${isDarkMode ? 'dark:text-white' : ''}`}>
              <ServicioCarrusel />
            </div>

            <div className={`static h-36 bg-bgFondo1 bg-cover bg-fixed w-full ${isDarkMode ? 'dark:bg-gray-900' : 'bg-gray-400'}`}>
              <div className="flex justify-center items-center w-full h-36 bg-gray-400 p-5">
                <h2 className={`text-white text-3xl font-textos text-center ${isDarkMode ? 'dark:text-gray-300' : ''}`}>Oferta Especial</h2>
              </div>
            </div>
            ...
            <div className={`flex flex-col items-center mb-40 ${isDarkMode ? 'dark:text-white' : ''}`}>
              <Link to={`/ofertas`} className={`no-underline hover:text-black md:w-1/2 w-4/5 ${isDarkMode ? 'dark:text-white' : ''}`}>
                <button className={`w-full h-16 border-black border-2 no-underline text-xl font-textos hover:bg-green-100 hover:font-bold ${isDarkMode ? 'dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-green-800' : ''}`}>
                  Ver Más Ofertas
                </button>
              </Link>
            </div>
