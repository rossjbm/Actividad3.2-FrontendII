...
export function Pago(){
    return(<>
        ...
        <div className="flex flex-col items-center gap-10 md:gap-16 text-center font-textos p-10 md:px-40 my-10">
            <h4 className="text-2xl font-bold">Ofrecemos Diversas Opciones de Pago para la Comodidad de Nuestros Huéspedes</h4>
            <div className="bg-gradient-to-t from-blue-200 to-green-100 p-5 flex flex-col gap-4">
